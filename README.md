...
╔════════════════════════════════════════════════════════════════════════════╗
║          ╔═════════════════════════════════════════════════════════════╗ ║
║          ║   ✨ NAGUI BOT - 84 COMANDOS - 100% FUNCIONAL ✨            ║ ║
║          ╠═════════════════════════════════════════════════════════════╣ ║
║          ║                                                               ║ ║
║          ║  🎮 Juegos Interactivos    │  🎵 Descargas Multimedia      ║ ║
║          ║  🤖 IA Avanzada (5 APIs)   │  🎨 Logos Textuales (13)     ║ ║
║          ║  💰 Sistema de Economía    │  🛡️ Gestión de Grupos        ║ ║
║          ║  📸 Stalking Social (2)    │  🔐 Autenticación Dual       ║ ║
║          ║  🚀 Anti-Detección Avanzado│  ⚡ Optimización Máxima      ║ ║
║          ║                                                               ║ ║
║          ╚═════════════════════════════════════════════════════════════╝ ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
**✨ Nagui Bot - El bot de WhatsApp más completo temático de Blue Lock ✨**
...
|-----------|----------|-------------|
| 👮 **Admin** | 25+ | Moderación, antispam, antistickers, kick, ban, etc |
| 🎮 **Juegos** | 6 | Ranking gay, tapa, beso, anime hello, etc |
| 🤖 **IA** | 7 | ChatGPT, Gemini, Bard, GPT-4, SORA, etc |
| 🎵 **Descargas** | 5 | YouTube/TikTok - MP3/MP4 |
| 🎨 **Logos** | 13 | 3D, Fire, Gold, Neon, Matrix, Graffiti, Shadow, etc |
| 💰 **Economía** | 4 | Trabajar, saldo, robar, apostar |
| 🛠️ **Herramientas** | 8 | Ping, uptime, hora, info, help, etc |
| 🔍 **Búsquedas** | 1 | YouTube search |
| 📸 **Stalking** | 2 | Instagram/TikTok stalk |
| 👑 **Owner** | 4 | Comandos exclusivos del dueño |
...
```json
{
  ...
  "usarprefixo": true,
  "version": "1.0",
  "criadorNumber": "270098094919864",
  "instagram": "",
  "urlapi": "http://localhost:3040/v1/chat/completions",
  "apikey": "dummy",
  "botoff": false,
  "antipv": false,
  "welcome": "¡Bienvenido @user al grupo!",
  "goodbye": "¡Adiós @user, esperamos verte pronto!",
  "antispam": true
}
```
...
║  Este es un proyecto público de código abierto.                         ║
║  Está TERMINANTEMENTE PROHIBIDO vender, comercializar o lucrar         ║
║  con este código.                                                        ║
║                                                                           ║
...
║                                                                              ║
║            Inspirado en Blue Lock 🔵⚫ | Hecho con 💖 por Oliver             ║
║                                                                              ║
║                    © 2024 - Código Abierto y Libre                          ║
║                                                                              ║
║              Desarrollado para la comunidad de WhatsApp Bots                ║
║                                                                              ║
║        ▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀          ║
║        ▀  ¡Espero que disfrutes usando Nagui Bot!  ▀                        ║
║        ▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀          ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
